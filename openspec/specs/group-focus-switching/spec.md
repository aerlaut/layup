# group-focus-switching Specification

## Purpose
Allow users to switch the focused group by clicking on context nodes or boundary areas, and to enter a neutral no-focus state by clicking on the canvas background.
